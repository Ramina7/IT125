...
class UI:
    def __init__(self):
        self.title = ft.Text('Создание пользователей', size=20, weight="bold")
        ...
        self.theme_btn = ft.ElevatedButton("Сменить тему")
        self.button = ft.ElevatedButton('Отправить резюме')

        self.photo = ft.Image(src="", width=120, height=120)
